...
file_path = Rails.root.join('app', 'assets', 'images', 'chenil.jpg').open
...
chenil.save
file_path = Rails.root.join('app', 'assets', 'images', 'chenil-la-poursuite-chien-traineau-30008.avif').open
